...
//    }
    ...
    /**
     * @brief prepare core number of vertices in previous graph
     */
    ...
    /**
     * @brief parallel insert maintenance
     */
    {
        ...
        if (core_compare::same_associative_map(previous_vertex_core_map5, contrastive_vertex_core_map)) {
            ...
            LOG(logger, LOG_RANK::INFO) << "Parallel Insertion," << maintenance_time<<","<<double(memory_size)/1024/1024 << "\n";
        }
