...
//    }
    ...
    vector<uint32_t> thread_vector{1, 2, 4, 8, 16};

    //vector<uint32_t> thread_vector{1, 2, 4, 8, 14};

    for (const auto &thread_number: thread_vector) {
...
//        }
         ...
         */
        {
            ...
            if (bipartite_core_compare::same(branch_left_index_map, branch_right_index_map, batch_left_vertex_map,
                                             batch_right_vertex_map)) {
