...
//        }
        ...
        {
            auto maintenance_time = order_maintenance(G, insertion_edge_vector, order_edge_truss_map, previous_edge_truss_support_map, previous_truss_order_map, previous_rem);
