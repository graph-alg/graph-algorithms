...
//        }
            ...
            previous_edge_truss_map);
    {
        ...
        order_maintenance_time = order_maintenance(G, removal_edge_vector, order_edge_truss_map,
                                                   previous_edge_truss_support_map,
...
//        {
//            auto decomposition_time = decompose(G, removal_edge_vector, contrast_edge_truss_map, t);
//
