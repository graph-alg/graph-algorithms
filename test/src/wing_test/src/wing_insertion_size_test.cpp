...
int main(int argc, char **argv) {
    ...
    string log_file_name = log_path + input_file_name + "_insertion_ratio_test.log";
    ...
    vector<double> ratio_vector{0.8, 1.0};
    for (auto &rate:ratio_vector) {
        ...
        auto G = load_graph(path,input_file_name,thread_number,rate,m,total_edge_vector,insertion_edge_vector);
