...
* @brief      : A common head file for multiple core decomposition and maintenance
* @version    : 1.0
* @date       : 2021/09/18
******************************************************************************************************************/
...
using scnu::hierarchy_multiple_core_maintenance;
using scnu::branch_multiple_core_maintenance;
