...
namespace scnu {
     ...
     */
    weighted_bipartite_graph::weighted_bipartite_graph() :
            left_vertex_map(make_shared<unordered_map<uint32_t, shared_ptr<weighted_left_vertex>>>()),
            right_vertex_map(make_shared<unordered_map<uint32_t, shared_ptr<weighted_right_vertex>>>()) {
    }
    ...
    weighted_bipartite_graph::weighted_bipartite_graph(
        ...
        for (const auto &[left_vertex_id, left_vertex]:*other_left_vertex_map) {
            left_vertex_map->insert({left_vertex_id, make_shared<weighted_left_vertex>(left_vertex)});
        }

        for (const auto &[right_vertex_id, right_vertex]:*other_right_vertex_map) {
            right_vertex_map->insert({right_vertex_id, make_shared<weighted_right_vertex>(right_vertex)});
        }
    }
     ...
     * @param graph
     */
    weighted_bipartite_graph::weighted_bipartite_graph(const shared_ptr<weighted_bipartite_graph> &graph)
            : weighted_bipartite_graph(graph->get_left_vertex_map(), graph->get_right_vertex_map()) {
     ...
     * @return
     */
    double weighted_bipartite_graph::get_density() {
     ...
     * @return
     */
    shared_ptr<weighted_bipartite_edge> weighted_bipartite_graph::get_edge(uint32_t left_vertex_id,
                                                                           uint32_t right_vertex_id) {
        auto left_vertex = get_left_vertex(left_vertex_id);
        return left_vertex ? left_vertex->get_edge(right_vertex_id) : shared_ptr<weighted_bipartite_edge>();
    }
     ...
     * @return
     */
    shared_ptr<unordered_set<shared_ptr<weighted_bipartite_edge>>> weighted_bipartite_graph::get_edge_set() {
        auto edge_set = make_shared<unordered_set<shared_ptr<weighted_bipartite_edge>>>();
     ...
     * @return
     */
    shared_ptr<weighted_left_vertex> weighted_bipartite_graph::get_left_vertex(uint32_t left_vertex_id) {
        return left_vertex_map->count(left_vertex_id) ? left_vertex_map->at(left_vertex_id)
                                                      : shared_ptr<weighted_left_vertex>();
    }
    ...
    /**
      ...
      * @return
      */
    shared_ptr<unordered_map<uint32_t, shared_ptr<weighted_left_vertex>>>
    weighted_bipartite_graph::get_left_vertex_map() {
     ...
     * @return
     */
    uint32_t weighted_bipartite_graph::get_maximal_left_vertex_degree() {
     ...
     * @return
     */
    uint32_t weighted_bipartite_graph::get_maximal_right_vertex_degree() {
        uint32_t max_degree = 0;
     ...
     * @return
     */
    shared_ptr<weighted_right_vertex> weighted_bipartite_graph::get_right_vertex(uint32_t right_vertex_id) {
        return right_vertex_map->count(right_vertex_id) ? right_vertex_map->at(right_vertex_id)
                                                        : shared_ptr<weighted_right_vertex>();
    }
     ...
     * @return
     */
    uint32_t weighted_bipartite_graph::get_edge_number() {
     ...
     * @return
     */
    uint32_t weighted_bipartite_graph::get_left_vertex_number() {
     ...
     * @return
     */
    uint32_t weighted_bipartite_graph::get_right_vertex_number() {
     ...
     * @return
     */
    shared_ptr<unordered_map<uint32_t, shared_ptr<weighted_right_vertex>>>
    weighted_bipartite_graph::get_right_vertex_map() {
     ...
     * @param e
     */
    void weighted_bipartite_graph::insert_edge(const shared_ptr<weighted_bipartite_edge> &e) {
     ...
     * @param left_vertex_id
     */
    void weighted_bipartite_graph::insert_left_vertex(uint32_t left_vertex_id) {
        left_vertex_map->insert({left_vertex_id, make_shared<weighted_left_vertex>(left_vertex_id)});
    }
     ...
     * @param right_vertex_id
     */
    void weighted_bipartite_graph::insert_right_vertex(uint32_t right_vertex_id) {
        right_vertex_map->insert({right_vertex_id, make_shared<weighted_right_vertex>(right_vertex_id)});
    }
     ...
     * @return
     */
    bool weighted_bipartite_graph::empty() {
    ...
    /**
      ...
      * @param edge
      */
    void weighted_bipartite_graph::remove_edge(const shared_ptr<weighted_bipartite_edge> &edge) {
    ...
    */
     ...
     * @param left_vertex_id
     */
    void weighted_bipartite_graph::remove_left_vertex(uint32_t left_vertex_id) {
     ...
     * @param right_vertex_id
     */
    void weighted_bipartite_graph::remove_right_vertex(uint32_t right_vertex_id) {
