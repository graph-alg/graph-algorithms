...
* @brief      : An I/O class for temporal bipartite graph input and output
* @version    : 1.0
* @date       : 2022/06/17
******************************************************************************************************************/
#pragma once
...
namespace scnu{
    class temporal_bipartite_graph_io
    {
    public:
        static shared_ptr<vector<shared_ptr<temporal_bipartite_edge>>> get_edge_vector(const string &path,
         ...
         */
        template <typename T>
        static void store_graph(const T edge_container, const string &output_file) {
