...
namespace scnu{
    class right_vertex_index {
    public:
        right_vertex_index();

        explicit right_vertex_index(const shared_ptr<right_vertex_index>& other_right_index);

        bool compare(const shared_ptr<right_vertex_index>& another_right_node_index);
        ...
        bool operator==(const shared_ptr<right_vertex_index>& another_right_node_index);
