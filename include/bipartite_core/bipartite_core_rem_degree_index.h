...
* @file       : bipartite_core_rem_degree_index.h
...
namespace scnu{
    class bipartite_core_rem_degree_index {
    public:
        bipartite_core_rem_degree_index();

        bipartite_core_rem_degree_index(const shared_ptr<bipartite_core_rem_degree_index>& other_core_rem_degree_index);
